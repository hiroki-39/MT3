...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
	...
	/*---変数の初期化---*/
	Vector3 axis = function.Normalize({ 1.0f,1.0f,1.0f });
	float angle = 0.44f;
	...
	while (Novice::ProcessMessage() == 0)
	{
		...
		Matrix4x4 rotationMatrix = function.MakeRotateAxisAgle(axis, angle);
		...
		function.MatrixScreenPrintf(0, 0, rotationMatrix, "RotationMatrix");
